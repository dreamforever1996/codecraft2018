...
def predict_vm(ecs_lines, input_lines):
    ...
    '''
    #predict_flavors = util.average_predict(tData_xy, base_date, end_date, predict_start_date, predict_end_date, flavor_names)
    predict_flavors = util.SLR_predict(tData_xy, base_date, end_date, predict_start_date, predict_end_date, flavor_names)
    ...
    pServers, pServers_Res = util.ratio_distribute(predict_flavors, ps_cpu_num, ps_mem_num, target, flavor_names, flavors)
    # 5. Record the result
